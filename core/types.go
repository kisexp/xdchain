...
type Processor interface {
	...
	Process(block *types.Block, statedb *state.StateDB, privateStateManager mps.PrivateStateRepository, cfg vm.Config) (types.Receipts, types.Receipts, []*types.Log, uint64, error)
}
